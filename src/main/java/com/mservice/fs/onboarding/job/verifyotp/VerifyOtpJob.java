...
import com.mservice.fs.onboarding.job.verifyotp.task.*;
 ...
 * @author muoi.nong
 */
@Processor(name = {OnboardingProcessor.VERIFY_OTP, OnboardingProcessor.VERIFY_OTP_QUICK})
public class VerifyOtpJob extends OnboardingJob<VerifyOtpRequest, VerifyOtpResponse> {

    public VerifyOtpJob(String name) {
        super(name);
    }
